...
#-mwindows supresses the console; remove for testing
LINKFLAGS := -lmingw32 -lSDL2main -lSDL2 -lSDL2_image -mwindows
OBJS := main.o component.o entity.o resource_manager.o graphics_system.o graphics_components.o location_components.o
OBJDIR := objects
SOURCEDIR := source
TARGET := Demo
